...
import wily.legacy.fantasy.util.TriState;
import net.minecraft.world.level.GameRules;
import wily.legacy.fantasy.util.GameRuleStore;
...
public final class RuntimeWorldConfig {
    ...
    public RuntimeWorldConfig setShouldTickTime(boolean shouldTickTime) {
        ...
        //this.gameRules.set(GameRules.RULE_DAYLIGHT, GameRules.BooleanValue.create(shouldTickTime));
        return this;
    }
     ...
     * @return The same instance of RuntimeWorldConfig
     */
    public <T extends GameRules.Value<T>> RuntimeWorldConfig setGameRule(GameRules.Key<T> key, T value) {
